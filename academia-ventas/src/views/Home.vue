<template>
  <div class="home">
    ...
    <b-container class="p-5 text-center">
      <a
        href="https://www.hola.com/imagenes/estar-bien/20180925130054/consejos-para-cuidar-a-un-gatito-recien-nacido-cs/0-601-526/cuidardgatito-t.jpg"
        target="_blank"
        >Descarga la malla aquí</a
      >
    </b-container>
  </div>
</template>
