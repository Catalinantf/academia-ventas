<template>
  <div>
    <v-app-bar color="deep-purple" dark>
      ...
      <v-toolbar-title class="cursor">Estás en la Vista de Adminstrador</v-toolbar-title>
      <v-spacer></v-spacer>
      <div class="mr-14">
      ...
      <v-list nav dense>
        ...
        >
          <v-list-item :to="{ name: 'Administracion' }">
            ...
            <v-list-item-title>Resumen Academia</v-list-item-title>
          </v-list-item>

          <v-list-item :to="{ name: 'ListasAcademia' }">
            <v-list-item-icon>
              <v-icon>mdi-account</v-icon>
            </v-list-item-icon>
            <v-list-item-title>Administración Academia</v-list-item-title>
          </v-list-item>
        </v-list-item-group>
      </v-list>
    </v-navigation-drawer>
